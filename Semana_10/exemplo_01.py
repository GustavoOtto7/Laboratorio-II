...
def generate_random_numbers(amount):
    my_file = open('Laboratorio-II/Semana_10/random-numbers.txt', 'w')
...
def avg_with_readline():
    my_file = open('Laboratorio-II/Semana_10/random-numbers.txt', 'r')
    sum_of_numbers = 0
    lines_count = 0
...
def main():
    ...
    print(avg_with_readline())
    print(avg_with_for())
    print(avg_with_readlines())
main()